...
import 'package:flutter_the_movie_database/domain/popular_movie_response.dart';
...
class ApiClient {
  ...
  // Универсальный get
  Future<T> _get<T>(T Function(dynamic json) parser, Uri url,
  ...
  Future<PopularMovieResponse> popularMovie(int page, String locale) async {
    ...
    final result = _get(parser, url,
        <String, dynamic>{"page": page.toString(), "language": locale});
    return result;
  }
